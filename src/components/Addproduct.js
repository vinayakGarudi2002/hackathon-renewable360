...
const {putData}=useContext(vendorcontext);
  ...
  const handleSubmit=async (e)=>{
    e.preventDefault();
    const status= await putData(ProductForm);
  ...
  return (
    ...
    <h1 className={"text-center my-2 login_signupForm"} style={{textShadow:`${bgColor.formText}`}}>Add Product</h1>
    ...
    Type of Source
          ...
          <select class="form-select" aria-label="Default select example"  name="type_of_source" onChange={(e) => {
              ProductFormChange(e);
            }} >
    ...
    <label htmlFor="location" className="form-label">
          ...
          <select class="form-select" aria-label="Default select example"  name="service_location" onChange={(e) => {
              ProductFormChange(e);
            }} >
